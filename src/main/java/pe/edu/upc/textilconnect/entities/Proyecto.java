...
public class Proyecto {
    ...
    public Proyecto(int idProyecto, String tituloProyecto, String descripcionProyecto,
                    String urlProyecto, String visibleProyecto, LocalDate fechaCreacion,
                    TipoProyecto tipoProyecto, Usuario usuario) {
